...
function PTS(props){
    ...
    const clasebase = 'boton puntoBtn ';
    ...
    const sumarPunto =() =>{setPuntos(puntos+1)};
    ...
    return(
        <div className="contenedorPTS">
            <div className={clasePuntoBtn} onClick={sumarPunto}><p>{puntos}</p>
            </div>
            <div className={claseContTiemp}>
                <button className={`boton tiempoBtn ${buttonDisabled ? 'disabled-button' : 'tiempoHover'}`} onClick={handleStartCountdownClick} disabled={buttonDisabled}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-letter-t" width="48" height="48" viewBox="0 0 24 24" strokeWidth="3" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="boton sancionBtn" onClick={openModalTypeS}>
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-cards" width="48" height="48" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            ...
            <Modal isOpen={isModalTypeSOpen} closeModal={closeModalTypeS}>
                <div className="grid grid2Column">
                    <button className="boton botonSancion" onClick={closeTypeOpenJugadores}>Conductual</button>
                    <button className="boton botonSancion" onClick={closeTypeOpenDemora}>Demora</button>
                </div>
            </Modal>
            <Modal isOpen={isModalDemoraOpen} closeModal={closeModalDemora}>
                <div className="grid grid2Column">
                    <button className="boton botonSancion fontSancion amonestacion" onClick={closeModalDemora}>A</button>
                    <button className="boton botonSancion fontSancion castigo" onClick={closeModalDemora}>C</button>
                </div>
            </Modal>
            <Modal isOpen={isModalJugadoresOpen} closeModal={closeModalJugadores}>
                <div className="grid grid4Column">
                    <button className="boton botonSancion fontSancion jugadorSan" onClick={closeJugadoresOpenCond}></button>
                    <button className="boton botonSancion fontSancion jugadorSan" onClick={closeJugadoresOpenCond}></button>
                    <button className="boton botonSancion fontSancion jugadorSan" onClick={closeJugadoresOpenCond}></button>
                    <button className="boton botonSancion fontSancion jugadorSan" onClick={closeJugadoresOpenCond}></button>
                    <button className="boton botonSancion fontSancion jugadorSan" onClick={closeJugadoresOpenCond}></button>
            ...
            <Modal isOpen={isModalCondOpen} closeModal={closeModalCond}>
                <div className="grid grid4Column">
                    <button className="boton botonSancion fontSancion amonestacion" onClick={closeModalCond}>A</button>
                    <button className="boton botonSancion fontSancion castigo" onClick={closeModalCond}>C</button>
                    <button className="boton botonSancion fontSancion desExp" onClick={closeModalCond}>E</button>
                    <button className="boton botonSancion fontSancion desExp" onClick={closeModalCond}>D</button>
                </div>
            </Modal>
        </div>
    );
